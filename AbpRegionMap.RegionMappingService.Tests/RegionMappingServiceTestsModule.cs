...
namespace AbpRegionMap.RegionMappingService.Tests;

/* This project has a dotnet project reference to the AbpRegionMap.RegionMappingService project,
 * but it does not have a module dependency to the AbpRegionMapRegionMappingServiceModule module class.
 * Because, AbpRegionMapRegionMappingServiceModule has configurations proper for development and production
 ...
 *
 * For example, AbpRegionMapRegionMappingServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change AbpRegionMapRegionMappingServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(AbpRegionMapRegionMappingServiceModule))]
public class RegionMappingServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<RegionMappingServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // RegionMappingServiceDbContext ()
        new RegionMappingServiceDbContext(
            new DbContextOptionsBuilder<RegionMappingServiceDbContext>().UseSqlite(connection).Options
